...
function generator(search) {
    ...
    if (!search) {
        ...
        if (!temporary.length) {
            document.getElementById("contacts").innerHTML = "<div class='empty'>Post not found</div>";
        }
    }
...
if (Object.keys(users).length === 0){
    document.getElementById("contacts").innerHTML = "<div class='empty'>There is no posts here</div>";
}
...
function del(id) {
    ...
    if (Object.keys(users).length === 0){
        document.getElementById("contacts").innerHTML = "<div class='empty'>There is no posts</div>";
    }
}
