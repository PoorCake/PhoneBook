...
function generator(search) {
    ...
    if (!search) {
        ...
        if (!temporary.length) {
            document.getElementById("contacts").innerHTML = "<div class='empty'>Contact not found</div>";
        }
    }
...
if (Object.keys(users).length === 0){
    document.getElementById("contacts").innerHTML = "<div class='empty'>There is no contacts here</div>";
}
            ...
            if(!/^[A-ZА-ЯЁ]+$/i.test(name)) {
                ...
                if(!phone) {
                    ...
                    if (phone.length < 17) {
                        ...
                        if(phone in users) {
                            alert("Number is already existed");
                        }else {
...
function del(id) {
    ...
    if (Object.keys(users).length === 0){
        document.getElementById("contacts").innerHTML = "<div class='empty'>There is no contacts</div>";
    }
}
